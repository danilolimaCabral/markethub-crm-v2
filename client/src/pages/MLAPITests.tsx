...
export default function MLAPITests() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Testes da API Mercado Livre</h1>
          <p className="text-muted-foreground mt-1">
            Valide a conexão e funcionalidade dos endpoints da API
          </p>
        </div>
        <Button
          onClick={runTests}
