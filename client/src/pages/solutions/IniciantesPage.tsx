                ...
                <div className="container mx-auto px-6">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        ...
                        <div className="lg:w-1/2 space-y-8">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-yellow-50 text-yellow-700 text-sm font-medium">
                                Para Quem Está Começando
                            </div>
                            <h1 className="text-5xl font-bold tracking-tight text-zinc-900 leading-tight">
                                Suas Primeiras 10 Vendas <span className="text-yellow-600">Garantidas</span>
                            </h1>
                            <p className="text-xl text-zinc-500 leading-relaxed">
                                Começar no Mercado Livre é difícil se você não tiver as ferramentas certas. O Markthub simplifica tudo para você não errar na precificação.
                            </p>

                            <ul className="space-y-4">
                                {[
                                    "Calculadora de lucro para não ter prejuízo",
                                    "Emissão de etiquetas simplificada",
                                    "Controle de estoque básico e eficiente",
                                    "Suporte via Chatbot IA 24/7"
                                ].map((item, i) => (
                            ...
                            <div className="pt-6">
                                ...
                                <p className="mt-4 text-sm text-zinc-400">Plano Starter gratuito para sempre (limite de vendas).</p>
                            </div>
                        </div>

                        <div className="lg:w-1/2 w-full">
                            <div className="relative">
                                <div className="absolute inset-0 bg-gradient-to-tr from-yellow-100 to-orange-100 rounded-[3rem] blur-3xl opacity-50" />
                                <div className="relative bg-white p-8 rounded-[2.5rem] shadow-[0_40px_80px_rgba(0,0,0,0.08)] border border-zinc-100 flex items-center justify-center min-h-[400px]">
                                    <Rocket className="w-32 h-32 text-yellow-200" />
                                </div>
                            </div>
                        </div>
                    </div>
